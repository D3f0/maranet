"""
This might not be necessary due to TCP PUSH flag but in
cases where no reliable connection is used this could be
helpful to retrieve packages that have been splitted
"""
